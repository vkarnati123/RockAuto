      ...
      <div className="max-w-[1200px] mx-auto px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <div className="w-16 h-0.5 bg-[#6366f1]"></div>
            <div className="flex items-center gap-2">
          ...
          <h1 className="text-[36px] text-gray-900 text-center">Payment Information</h1>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-[24px] text-gray-900">Payment Method</h2>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border ${errors.cardNumber ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border ${errors.cardName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-4 py-3 border ${errors.expiryDate ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                          placeholder="MM/YY"
                          maxLength={5}
                        />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-4 py-3 border ${errors.cvv ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                          placeholder="123"
                          maxLength={3}
                        />
                ...
                <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-green-900 mb-1">Your payment is secure</p>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                <h2 className="text-[24px] text-gray-900 mb-6">Billing Address</h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border ${errors.billingAddress ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                        placeholder="123 Main Street"
                      />
                      {errors.billingAddress && (
                        <p className="text-red-600 text-sm mt-1">{errors.billingAddress}</p>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 border ${errors.billingCity ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                          placeholder="New York"
                        />
                        {errors.billingCity && (
                          <p className="text-red-600 text-sm mt-1">{errors.billingCity}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 border ${errors.billingState ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                          placeholder="NY"
                        />
                        {errors.billingState && (
                          <p className="text-red-600 text-sm mt-1">{errors.billingState}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 border ${errors.billingZipCode ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6366f1]`}
                          placeholder="10001"
                        />
                        {errors.billingZipCode && (
                          <p className="text-red-600 text-sm mt-1">{errors.billingZipCode}</p>
                        )}
                      </div>
                    </div>
                  </div>
